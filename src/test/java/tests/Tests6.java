...
public class Tests6 {
    ...
    @Test
    public void CP006_Vaciar_Carrito(){
        dataCP = DataDriven.getData("CP006_Vaciar_Carrito");
        ...
        articulos.quitarArticulo();
        Assert.assertEquals(articulos.quitarArticulo(), dataCP.get(3));
