...
public class Tests5 {
    ...
    @Test
    public void CP005_Correo_Registrado(){
        dataCP = DataDriven.getData("CP005_Correo_Registrado");
        ...
        Assert.assertEquals(creacionCuenta.failedCuenta(), dataCP.get(9));
    }
